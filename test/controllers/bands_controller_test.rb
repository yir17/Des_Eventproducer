...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { kind: @band.kind, name: @band.name, start_date: @band.start_date } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { kind: @band.kind, name: @band.name, start_date: @band.start_date } }
